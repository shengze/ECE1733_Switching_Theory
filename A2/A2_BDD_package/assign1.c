...
//	t_blif_cubical_function *function1;
//	t_blif_cubical_function *function2;
	...
	if (circuit != NULL)
	{
		...
		for (index = 0; index < circuit->function_count; index++)
		{
			...
			ROBDD_package(function);
		}
		

		/* Apply Algorithm if it is applicable */
//		printf("Apply Algorithm of Two Functions\n\n");
		
//		apply_alg(function1, function2);
